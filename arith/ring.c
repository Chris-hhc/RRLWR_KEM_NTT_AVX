...
static void ring_Awin_prepare_twists(ring_element_Awin *aw,
                                     int32_t prime,
                                     int32_t primeinv,
                                     int32_t oneR,
                                     int32_t twoR,
                                     int32_t fp_zetas[RRLWR_N])
{
  ring_Awin_prepare_twists_ncoeffs(aw, RRLWR_K, prime, primeinv, oneR, twoR, fp_zetas);
}
                       ...
                       int32_t fp_zetas[RRLWR_N])
{
  ...
  ring_Awin_prepare_twists(aw, prime, primeinv, oneR, twoR, fp_zetas);
}

  ...
  unsigned char *ct, unsigned long long *ct_len_bytes)
{
  ...
  RRLWR_KEM_HASH_G(K_seedSp, RRLWR_KEM_SS_LEN + RRLWR_SEED_S_LEN,
                   hpk_m, RRLWR_KEM_HPK_LEN + RRLWR_PKE_MESSAGE_LEN);
  ...
  unsigned char *ss, unsigned long long *ss_len_bytes)
{
  ...
  unsigned char ct_z[RRLWR_KEM_CT_LEN + RRLWR_KEM_SEED_Z_LEN];
  unsigned char *z = ct_z + RRLWR_KEM_CT_LEN;
  ...
  ts = cpucycles();
  RRLWR_KEM_HASH_G(K_seedSp, RRLWR_KEM_SS_LEN + RRLWR_SEED_S_LEN,
                   hpk_mp, RRLWR_KEM_HPK_LEN + RRLWR_PKE_MESSAGE_LEN);
  ...
  RRLWR_KEM_HASH_H(Kb, RRLWR_KEM_SS_LEN, ct_z,
